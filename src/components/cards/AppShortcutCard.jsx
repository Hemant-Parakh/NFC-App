...
export default function AppShortcutCard({ action, accentColor }) {
  const handleOpen = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Smartphone size={17} style={{ color: accentColor }} strokeWidth={2} />
      </div>
      ...
      >
        <ArrowUpRight size={14} style={{ color: accentColor }} strokeWidth={2} />
      </div>
    </motion.button>
  )
}
